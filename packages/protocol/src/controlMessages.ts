...
export const BatchOfferSchema = z.object({
...
export const FilePauseSchema = z.object({
...
export const FileCancelSchema = z.object({
...
export const FileVerifiedSchema = z.object({
...
export const ResumeAcceptSchema = z.object({
...
export const ResumeDenySchema = z.object({
